"""
Django settings for yddhydh_14 project.
...
WSGI_APPLICATION = 'yddhydh_14.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "yddhydh_14 API",
    "DESCRIPTION": "API documentation for yddhydh_14 App",
    "VERSION": "v1",
}
